 ...
 */
    ...
    abstract class Controller
    {
         ...
         *
         * @return Manseds\Renderer\Renderer
         */
         ...
         * @param Manseds\Renderer\Renderer
         */
